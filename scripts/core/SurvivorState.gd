...
var field_equipment_sanitized_count: int = 0
var field_equipment_conversion_only_count: int = 0
var field_equipment_converted: int = 0
var knockback_blocked_count: int = 0
var enemy_position_recovery_count: int = 0
...
func start_new_run(seed_value: int = 0, seed_text: String = "") -> void:
	...
	field_equipment_sanitized_count = 0
	field_equipment_conversion_only_count = 0
	field_equipment_converted = 0
	knockback_blocked_count = 0
	enemy_position_recovery_count = 0
	field_gimmicks_triggered = 0
	cursed_relic_count = 0
	var initial_unlocks = UnlockSystemScript.new()
	unlocked_weapon_ids = initial_unlocks.initial_weapon_ids()
	unlocked_passive_ids = initial_unlocks.initial_passive_ids()
	disabled_weapon_ids = []
